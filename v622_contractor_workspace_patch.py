...
def patch_contractor_workspace(source: str) -> str:
    ...
    ai_new = '''    ("🤖 AI", lambda: render_ai_assistant(_master_pid)),\n'''
    ...
    if (
        ...
        or "_v622_render_contractor_management" in source
    ):
