...
from qlda.runtime_core.contractor_ai_context import install_contractor_ai_context, multi_contractor_component_aggregate
from qlda.runtime_core.contractor_workspace import add_contractor, ensure_default_contractor, install_contractor_workspace
...
class ContractorAIContextTests(unittest.TestCase):
    ...
    def test_component_aggregate_uses_highest_ipc_separately_per_contractor(self):
        ...
        with patch("qlda.runtime_core.project_remaining_components.project_remaining_components", side_effect=fake_remaining) as calc:
    ...
    def test_incomplete_contractor_prevents_project_total_being_marked_valid(self):
        ...
        with patch("qlda.runtime_core.project_remaining_components.project_remaining_components", side_effect=side_effect):
            result = multi_contractor_component_aggregate(object(), contractors)
