...
class QLDAAutomationRuntimeTests(unittest.TestCase):
    ...
    def test_runtime_supervisor_updates_twin_and_emits_findings(self):
        ...
        twin = platform.digital_twin.get(self.project_id)
        self.assertIsNotNone(twin)
        self.assertEqual(twin.production_progress, 72.0)
