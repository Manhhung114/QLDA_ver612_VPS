...
from qlda.runtime_core.settings_store import APP_SETTINGS_FILE, DEFAULT_SPECIFIED_SEARCH_DOMAINS, get_specified_search_domains, load_app_settings, save_app_settings
