...
from qlda.runtime_core.approval_revision import install_db_patch as _install_workflow_compat
...
def _install_drive_fast_path() -> None:
    from qlda.runtime_core.drive_gateway import DriveGateway, DriveGatewayError
