...
from qlda.runtime_core.contractor_workspace import contractor_rows_connection, resolve_master_project_id_connection
...
def multi_contractor_component_aggregate(connection, contractors: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    """
    from qlda.runtime_core.project_remaining_components import project_remaining_components
